...
WebUI.click(findTestObject('Page_ProjectBackend/h5_Garden'))

WebUI.click(findTestObject('Page_ProjectBackend/h5_Banana'))

WebUI.click(findTestObject('Page_ProjectBackend/h5_Orange'))

WebUI.click(findTestObject('Page_ProjectBackend/h5_Papaya'))

WebUI.click(findTestObject('Page_ProjectBackend/h5_Rambutan'))
