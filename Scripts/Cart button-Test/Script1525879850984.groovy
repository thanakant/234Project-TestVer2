...
WebUI.setText(findTestObject('Cart Button/Page_ProjectBackend/input_username'), username)

WebUI.setText(findTestObject('Cart Button/Page_ProjectBackend/input_password'), password)
